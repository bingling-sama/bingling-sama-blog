...
<div>
    <div class="title-box">
        ...
        <div @click="goMyweb('https://www.yabl.online')" class="feel-title">心情</div>
    </div>
    <!-- 说说-->
    ...
    <div class="title-box">
        <div @click="goMyweb('https://www.yabl.online/message')" class="title">留言</div>
...
<script>
import blContent from "../components/bl-content.vue";
...
export default {
    ...
    data() {
        return {
            ...
            sList: [],
            messageList: [],
            webUrl: 'https://www.yabl.online/api/github'
        }
    },
    methods: {
        changePageId() {
