...
<script>
import $ from 'jQuery';
import robot from "../components/bl-robot.vue";
export default {
    components: {
        robot
    },
    ...
    methods: {
        reciveResult(txt) {
            ...
            audio.setAttribute("src", 'https://yabl.online/mm/speech?text=' + txt.you);
            audio.play();
        },
        loadJs(url, callback) {
    ...
    mounted() {
        ...
        //     // this.loadJs("https://www.yabl.online/res/js/message.js")
        //     this.loadJs("https://www.yabl.online/res/js/live2d.js")
        //     window.onload = () => {
